<template>
  <div id="home-hero-image-15019988" class="home-hero-image" alt="Enjoy over 25% Off Fire Pits, Summer fun for less. Hero Image" title="">
		<!-- If video, reference file, code goes here -->
		<div id="home-hero-image-icon-15019988" class="home-hero-image-icon">
			<!-- IF SVG and check height width <svg xmlns="http://www.w3.org/2000/svg" height="78" width="78" "desktop= height="125" width="125"""><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#fall-event"></use></svg> -->
		</div>
